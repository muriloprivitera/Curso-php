<nav class="modulos">
                <div class="modulo roxo">   
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="exercicio.php?dir=db&file=inserir_registro">
                                Inserir Registro #1
                            </a>
                        </li>
                        <li>
                ...
                <div class="modulo vermelho">
                    <h3>12. Sessao e Cookies</h3>
                    <ul>
                        <li>
                            <a href="exercicio.php?dir=sessao_cookies&file=sessao">
                                Sessao #1
                            </a>
                        </li>
                        <li>
                            <a href="exercicio.php?dir=sessao_cookies&file=gerenciando_sessao">
                                Gerenciando sessao
                            </a>
                        </li>
                    </ul>
